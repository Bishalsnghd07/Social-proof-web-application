    ...
    <main className='flex min-h-screen items-center justify-center lg:pl-4 lg:pr-4'>
      ...
      <div className='z-10'>
        <section className="grid grid-cols-1 lg:grid-cols-2 lg:max-w-[74rem]">
          ...
          <p className='font-sans font-medium pt-4 lg:pt-6 text-lg text-neutral-dark-grayish-magenta text-center lg:text-left lg:max-w-[26.8rem]'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 pt-12 lg:pt-[3.8rem] lg:pl-6 lg:pr-[0.7rem] lg:max-w-[74rem] pb-8 lg:pb-0'>
          <Testimonials />
        </div>
      </div>
      <Image
