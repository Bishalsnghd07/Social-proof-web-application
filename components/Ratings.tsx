...
const Ratings = () => {
  return (
    ...
    <div className='flex flex-col lg:flex-row bg-neutral-light-grayish-magenta p-[0.77rem] gap-2 lg:gap-6 justify-center items-center w-full lg:max-w-[29.4rem] lg:pr-12 rounded-lg'>
    ...
    <div className='flex flex-col lg:flex-row bg-neutral-light-grayish-magenta p-[0.77rem] gap-2 lg:gap-6 justify-center items-center w-full lg:max-w-[29.4rem] lg:pl-1 lg:pr-6 rounded-lg'>
    <div className='flex flex-wrap gap-2'>
          <Icon icon="star" 
          aria-hidden="true" />
          <Icon icon="star" aria-hidden="true" />
