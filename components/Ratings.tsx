...
const Ratings = () => {
  return (
    ...
    <div className='flex flex-col lg:flex-row bg-neutral-light-grayish-magenta p-[0.84rem] gap-2 lg:gap-6 justify-center items-center w-full lg:max-w-[29.4rem] lg:pr-12 rounded-lg'>
