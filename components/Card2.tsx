...
const Card2 = () => {
  ...
  return (
    <>
      <motion.div className="flex flex-col lg:flex-row gap-7 lg:pl-32 lg:pr-32 pl-6 pr-6" variants={textVariants} initial="initial" animate="animate">
        <div className='lg:pt-[1rem]'>
        <div className="border bg-primary-very-dark-magenta lg:w-[20.1rem] w-full rounded-lg">
        ...
        <div className="border bg-primary-very-dark-magenta lg:w-[20.1rem] lg:h-[13rem] rounded-lg">
        <div className='grid grid-cols-2 pl-[2rem] pt-[1.5rem] w-[8rem]'>
            <Image
