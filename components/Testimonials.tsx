  ...
  return (
    <>
      <ul className='justify-start items-start pl-5 lg:pl-0 pr-5 lg:pr-6'>
        <li className='p-9 bg-primary-very-dark-magenta rounded-lg lg:h-[13rem]'>
          ...
          <Image
            ...
            <blockquote className='text-white font-normal text-sm'>&quot;We needed the same printed design as the one we had ordered a week prior. Not only did they find the original order, but we also received it in time. Excellent!&quot;</blockquote>
          </figure>
        </li>
      </ul>
      <ul className='justify-start items-start pl-5 lg:pl-2 pr-5 lg:pr-6 pt-4'>
        <li className='bg-primary-very-dark-magenta rounded-lg p-10 lg:h-[13.2rem]'>
          <figure className='flex flex-wrap  gap-4'>
          <Image
            ...
            <blockquote className='text-white font-normal text-sm'>&quot;Put an order with this company and can only praise them for the very high standard. Will definitely use them again and recommend them to everyone!&quot;</blockquote>
          </figure>
        </li>
      </ul>
      ...
      <ul className='justify-start items-start pl-5 lg:pl-2 pr-5 lg:pr-4 pt-4 lg:pt-[1.9rem]'>
        <li className='bg-primary-very-dark-magenta rounded-lg p-10 lg:h-[13.4rem]'>
          ...
          <Image
            ...
            <blockquote className='text-white font-normal text-sm'>&quot;Customer service is always excellent and very quick turn around. Completely delighted with the simplicity of the purchase and the speed of delivery.&quot;</blockquote>
          </figure>
        </li>
      </ul>
    </>
